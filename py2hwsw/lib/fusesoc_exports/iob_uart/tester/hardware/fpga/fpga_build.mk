...
RUN_DEPS+=iob_uart_tester_bootrom.hex iob_uart_tester_firmware.hex
...
BUILD_DEPS+=iob_uart_tester_bootrom.hex $(if $(filter $(INIT_MEM),1),iob_uart_tester_firmware.hex)
