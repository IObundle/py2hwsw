...
Simple AXI Stream (AXIS) to AXI adapter
   ...
   Both AXIS In and AXIS Out operate individually and can work simultaneously (these units can also be instantiated individually, check iob_axis2axi_in.v and iob_axis2axi_out.v)
...
module iob_axis2axi #(
   ...
   iob_axis2axi_in #(
      ...
      `include "iob_axis2axi_in_axi_write_m_m_portmap.vs"
   ...
   iob_axis2axi_out #(
      ...
      `include "iob_axis2axi_out_axi_read_m_m_portmap.vs"
