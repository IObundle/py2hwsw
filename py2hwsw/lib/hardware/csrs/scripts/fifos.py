...
def find_and_update_fifo_csrs(csrs_dict):
    ...
    csr_group_ref["regs"] += fifo_csrs  # FIXME: Correct fifo type, name, and width
...
def create_sync_fifos_instances(attributes_dict, sync_fifos):
...
def create_async_fifos_instances(attributes_dict, async_fifos):
    """Given lists of names for fifos, the ports, wires and blocks for them"""
