...
def setup(py_params_dict):
    ...
    if params["use_ethernet"]:
        attributes_dict["ports"] += [
            {
                "name": "mii_io",
                "descr": "Ethernet RGMII interface",
                "signals": {
                    "type": "mii",
                    "variant": "rgmii",
                },
...
"""
    ...
    assign uut_mii_rxd = {enet_rx_d3_i, enet_rx_d2_i, enet_rx_d1_i, enet_rx_d0_i};
    assign uut_mii_rx_dv = enet_rx_dv_i;
    //assign uut_mii_rx_er = enet_rx_err_o;
    assign uut_mii_rx_er = 1'b0;

    assign uut_mii_tx_clk = eth_clk;
    assign {enet_tx_d3_o, enet_tx_d2_o, enet_tx_d1_o, enet_tx_d0_o} = uut_mii_txd;
    assign enet_tx_en_o = uut_mii_tx_en;
    //assign enet_tx_err_o = uut_mii_tx_er;
