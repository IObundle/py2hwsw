...
This step 1. can be fully automated by using the Py2HWSW's [iob_linux_device_drivers](https://github.com/IObundle/py2hwsw/blob/linux_csrs_script/py2hwsw/lib/software/iob_linux_device_drivers/iob_linux_device_drivers.py) software module.
To use this software module, add it to the 'sw_modules' list of the peripheral core, like in [iob_timer](https://github.com/IObundle/py2hwsw/blob/linux_csrs_script/py2hwsw/lib/peripherals/iob_timer/iob_timer.py#L157) core.
