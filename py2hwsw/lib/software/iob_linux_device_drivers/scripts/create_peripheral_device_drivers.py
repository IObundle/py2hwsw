...
def create_driver_header_file(path, peripheral):
    ...
    fswhdr.write(
        " * `create_driver_header_file` method of `create_peripheral_device_drivers.py`\n"
    )
    fswhdr.write(" */\n\n")
...
def create_driver_sysfs_header_file(
    path, peripheral, multi=False
):  # (table, out_dir, top, multi=False):
