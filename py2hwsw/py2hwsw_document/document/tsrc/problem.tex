...
\begin{itemize}
    ...
    \item \textbf{Integration of Existing Designs}: Many projects involve legacy Verilog cores that need to be integrated with new designs. Py2hwsw facilitates this integration, allowing users to provide existing components and still benefit from the remaining automation features.
