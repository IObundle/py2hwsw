...
% Anchor names derived from counters repeat across pagenumbering resets
...
\input{ug_title}
\date{\today}
\category{Design Specification, \input{\NAME_version.tex}, Build \input{shortHash.tex}}
...
\vspace*{\fill}
Design Specification, \input{\NAME_version.tex}, Build \input{shortHash.tex}
...
\subsection{Interface class: interfaces.py}
\label{sec:if_gen}
\input{if_gen}
